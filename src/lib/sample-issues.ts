/**
 * The three sample issues. Used by the seed script and by demo mode, so the
 * local mockup and a seeded database show exactly the same reading.
 *
 * The texts are short public domain excerpts, abridged for development.
 */
export type Seed = {
  text: {
    issue_no: number;
